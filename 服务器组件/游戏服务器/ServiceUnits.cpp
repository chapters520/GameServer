...
bool CServiceUnits::LoadDataBaseParameter(LPCTSTR pszDataBaseAddr, LPCTSTR pszDataBaseName, tagDataBaseParameter & DataBaseParameter)
{
	...
	try
	{
		...
		PlatformDBAide.GetValue_String(TEXT("DBUser"), DataBaseParameter.szDataBaseUser, CountArray(DataBaseParameter.szDataBaseUser));
		PlatformDBAide.GetValue_String(TEXT("DBPassword"), DataBaseParameter.szDataBasePass, CountArray(DataBaseParameter.szDataBasePass));
