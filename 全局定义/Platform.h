...
//平台常量
const TCHAR	szProduct[]=TEXT("网狐棋牌");							//产品名字
const TCHAR szPlazaClass[]=TEXT("AQPGamePlaza");					//广场类名
const TCHAR szProductKey[]=TEXT("AQPGamePlatform");					//产品主键

//地址定义
const TCHAR szCookieUrl[]=TEXT("http://10.10.10.250:8080");						//记录地址
const TCHAR szLogonServer[]=TEXT("127.0.0.1");						//登录地址
const TCHAR szPlatformLink[]=TEXT("http://10.10.10.250:8000");				//平台网站
