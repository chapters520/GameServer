...
VOID CDlgSearchTable::OnOK()
{
	...
	{
		//设置界面
		m_btAutoJoin.EnableWindow(FALSE);
	...
	m_pTableViewFrame->FlashGameChair(SearchTable.wResultTableID, SearchTable.wResultChairID);
...
VOID CDlgSearchTable::OnBnClickedAutoJoin()
{
	...
	//百人游戏
	if(m_pTableViewFrame->GetChairCount() >= INDEX_ENTER_CHAIR)
