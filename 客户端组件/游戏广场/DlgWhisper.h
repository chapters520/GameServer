...
protected:
	...
	//控制按钮
protected:
	CSkinButton						m_btShieldThisChat;					//屏蔽聊天
	CSkinButton						m_btAddFriend;						//加为好友
	CSkinButton						m_btSetDetest;						//设为厌恶
	CSkinButton						m_btMessageSetting;					//消息设置
...
protected:
	...
	CSkinButton						m_btChatButton3;					//喇叭按钮
...
protected:
	...
	CEncircleBMP					m_EncircleHistoryEdit;				//聊天环绕
