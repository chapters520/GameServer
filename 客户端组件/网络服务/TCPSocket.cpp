...
//取消代理
/*void CTCPSocket::CancelProxyServer()
{
...
//代理服务器
bool CTCPSocket::SetProxyServerInfo(BYTE ProxyServerType, const tagProxyServer & ProxyServer)
{
...
//连接服务器
BYTE CTCPSocket::Connect(const LPCTSTR pszServerIP, WORD wPort)
{
	//效验数据
	ASSERT(wPort!=0);
...
/*extern "C" __declspec(dllexport) void * CreateTCPSocket(const GUID & Guid, DWORD dwInterfaceVer)
{
	//建立对象
