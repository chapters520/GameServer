...
/////////////////////////////////////////////////////////////////
//
// Header file : internal.h
//
// Description  :
//
// The SkinSB library can for the windows controls set up custom skin, 
// to achieve the effect of beautification, such as: Edit, ListCtrl, 
// TreeCtrl etc.. some windows standard controls or user custom controls.
//
// This source code is easy to use, the C language source code, exported 
// standard API functions interface and no depend other added Library. 
// can be used in other languages, only need release a dynamic link library (DLL).
//
// Author      : LiJun
//
